...
We need the following textbook results from \autocite{kunen1980} and \autocite{jech1973}.
...
\begin{theorem} \label{theorem:jech_zf_model}
    ...
    \(\M\) satisfies all the axioms of \ZFminus except possibly \Axiom{Comprehension}.
    If \(\M\) also satisfies 8 particular instances of \Axiom{Comprehension} by being closed under Gödel operations,
